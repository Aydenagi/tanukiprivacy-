...
Hermes is a modular trading agent designed for **real trading** (no paper mode). It provides a clean CLI, small but expressive strategy layer, exchange adapters for **Solana** and **EVM chains**, and an optional **LLM‑assisted policy**.
...
docker run --rm -it --env-file .env hermes --help
```
...
**Q: Does Hermes support Pump.fun tokens?**  
